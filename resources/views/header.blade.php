			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Bùi Xương Trạch, Khương Đình, Thanh Xuân, Hà Nội </a></li>
						<li><a href=""><i class="fa fa-phone"></i> 01663 685 981</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						@if(Auth::check())
							<li><a href="{{route('get-signup')}}"><i class="fa fa-user"></i>Chào bạn {{Auth::user()->full_name}}</a></li>
							<li><a href="{{route('get-logout')}}">Đăng xuất</a></li>
						@else{
							<li><a href="{{route('get-signup')}}">Đăng kí</a></li>
							...
							<div class="beta-dropdown cart-body">
								@if(Session::has('cart'))
									...
									<div class="cart-caption">
										...
										<div class="center">
											<div class="space10">&nbsp;</div>
											<a href="{{route('get-dat-hang')}}" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
										</div>
									</div>
								@endif
							</div>
